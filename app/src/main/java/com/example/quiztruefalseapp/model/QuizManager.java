...
import com.example.quiztruefalseapp.MyApplication;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int index=0;index<results.length();index++){
                        ...
                        QuizQuestion myQuizQuestion = new QuizQuestion(questionText,questionAnswer);
                        quizQuestions.add(myQuizQuestion);
                    }
